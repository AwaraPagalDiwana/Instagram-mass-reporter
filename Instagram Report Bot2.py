...
def getOptions(args=sys.argv[1:]):
    ...
    parser.add_argument("-u", "--arhamonline", type = str, default = "", help = "arhamonline to report.")
...
username = args.arhamonline
acc_file = args.file

if username == "" :
	username = input("arhamonline: ")
...
for line in range(len(file)+1):
    web = Browser()
    web.go_to("https://www.instagram.com/arhamonline?igsh=MW1hZTc0YnAwYmNw")

    web.type(user[line], into='8655103793, arhamonline, or info@arhamonline.com')
    time.sleep(0.5)
